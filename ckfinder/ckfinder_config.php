...
$config['LicenseKey'] = !empty($ckeditor_wordpress->options['ckfinder']['license_key']) ? $ckeditor_wordpress->options['ckfinder']['license_key'] : '';
...
*/
$baseUrl = $ckeditor_wordpress->user_files_url;
...
ATTENTION: The trailing slash is required.
*/
$baseDir = $ckeditor_wordpress->user_files_absolute_path;
...
$config['Thumbnails'] = Array(
		...
		'enabled' => $ckeditor_wordpress->options['ckfinder']['thumbnails_enabled'] == 't' ? true : false,
		'directAccess' => $ckeditor_wordpress->options['ckfinder']['thumbnails_direct_access'] == 't' ? true : false,
		'maxWidth' => $ckeditor_wordpress->options['ckfinder']['thumbnails_width'],
		'maxHeight' => $ckeditor_wordpress->options['ckfinder']['thumbnails_height'],
		'bmpSupported' => false,
		'quality' => $ckeditor_wordpress->options['ckfinder']['thumbnails_quality']);
...
*/
$config['Images'] = Array(
		'maxWidth' => $ckeditor_wordpress->options['ckfinder']['images_width'],
		'maxHeight' => $ckeditor_wordpress->options['ckfinder']['images_height'],
		'quality' => $ckeditor_wordpress->options['ckfinder']['images_quality']);
...
$config['AccessControl'][] = Array(
		...
		'folderView' => current_user_can('ckeditor_ckfinder_folderView'),
		'folderCreate' => current_user_can('ckeditor_ckfinder_folderCreate'),
		'folderRename' => current_user_can('ckeditor_ckfinder_folderRename'),
		'folderDelete' => current_user_can('ckeditor_ckfinder_folderDelete'),

		'fileView' => current_user_can('ckeditor_ckfinder_fileView'),
		'fileUpload' => current_user_can('ckeditor_ckfinder_fileUpload'),
		'fileRename' => current_user_can('ckeditor_ckfinder_fileRename'),
		'fileDelete' => current_user_can('ckeditor_ckfinder_fileDelete'));
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_wordpress->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_wordpress->options['upload']['files_allowed_ext'],
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_wordpress->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_wordpress->options['upload']['images_allowed_ext'],
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $ckeditor_wordpress->options['ckfinder']['file_max_size'],
		'allowedExtensions' => $ckeditor_wordpress->options['upload']['flash_allowed_ext'],
		'deniedExtensions' => '');
